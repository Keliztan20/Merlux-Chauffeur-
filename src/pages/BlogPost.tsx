...
export default function BlogPost() {
  ...
  const articleDate = post.date || (post.createdAt?.seconds ? new Date(post.createdAt.seconds * 1000).toLocaleDateString() : '');
      ...
      <article className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-widest text-white/40 font-bold mb-6">
            ...
            <span className="flex items-center gap-1"><Calendar size={12} /> {articleDate}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-3">
              <div 
                className="cms-rendered-content prose prose-invert prose-gold max-w-none prose-p:text-white/60 prose-p:leading-relaxed prose-headings:font-display prose-headings:text-white prose-li:text-white/60"
